...
# - uv package manager (auto-downloads Python 3.14)
...
install_uv() {
    ...
    print_info "uv will automatically download and manage Python 3.14"
}
...
install_dependencies() {
    ...
    print_info "Using uv to install SCOPE with Python 3.14..."
    ...
    print_success "Python dependencies installed (Python 3.14 managed by uv)"
...
create_env_file() {
    ...
    cat > .env <<EOF
# =============================================================================
# SCOPE Configuration - Auto-generated by setup.sh
# Generated on: $(date)
# PostgreSQL: Native installation (no containers)
...
# -----------------------------------------------------------------------------
SCOPE_EMBEDDING_PROVIDER=sentence-transformers
...
# Data Configuration
# -----------------------------------------------------------------------------
SCOPE_DATASET_PATH=data/Conversation.csv
...
# -----------------------------------------------------------------------------
SCOPE_ENABLE_EVALUATION=true
SCOPE_LABELED_TEST_DATA=data/labeled_test_data_clean.csv

# -----------------------------------------------------------------------------
# PostgreSQL Configuration (Native installation)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# PostgreSQL Vector Index Settings (Advanced)
# -----------------------------------------------------------------------------
# SCOPE_INDEX_TYPE=hnsw
# SCOPE_EMBEDDING_DIM=384
# SCOPE_HNSW_M=16
# SCOPE_HNSW_EF_CONSTRUCTION=64
# SCOPE_IVFFLAT_LISTS=100
EOF
...
print_next_steps() {
    ...
    echo "  • Python: 3.14 (managed by uv)"
...
main() {
    ...
    echo "  • uv package manager (auto-downloads Python 3.14)"
